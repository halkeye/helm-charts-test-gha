...
*/}}
{{- define "matrix-dimension.fullname" -}}
...
*/}}
{{- define "matrix-dimension.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "matrix-dimension.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
